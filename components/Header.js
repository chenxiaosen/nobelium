...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 1, name: "twitter", to: 'https://twitter.com/seanchan_', show: true, external: true },
...
export default function Header({ navBarTitle, fullWidth }) {
  ...
  // const resolveFavicon = fallback => !fallback && dark ? '/favicon.dark.gif' : '/favicon.gif'
  const resolveFavicon = fallback => !fallback && dark ? '/town.gif' : '/town.gif'
